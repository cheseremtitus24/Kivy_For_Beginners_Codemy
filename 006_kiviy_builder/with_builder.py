...
# Since we are using a kivy design file we no longer have to import all the labels, button and input
# texts

#defining the design file using the builder object

# Builder.load_file('whatever.kv')
##### Method 2 to load in the design file ######
